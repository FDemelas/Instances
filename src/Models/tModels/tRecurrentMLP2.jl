...
"""
function create_NN(lt::RnnTModelSampleInsidefactory,recurrent_layer=GRUv3, h_decoder::Vector{Int} = [512, 256], h_act = tanh, h_representation::Int = 128, seed::Int = 1, norm::Bool = false)
